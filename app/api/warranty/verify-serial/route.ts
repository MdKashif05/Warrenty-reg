...
const DEV_SERIALS: Record<string, { productName: string; category: string; warrantyMonths: number; productModelName?: string }> = {
  ...
  "TLX-8821-9942": { productName: "LX-TIM Ultra", category: "THERMAL_PASTE", warrantyMonths: 12, productModelName: "5g Syringe" },
  "TLX-5512-3301": { productName: "LX-LM Elite", category: "LIQUID_METAL", warrantyMonths: 12, productModelName: "1.0g Applicator" },
  "TLX-9940-1122": { productName: "LX-PAD Standard", category: "THERMAL_PADS", warrantyMonths: 12, productModelName: "1.5mm Sheet" },
  "TLX-7733-4411": { productName: "LX-PAD Pro", category: "THERMAL_PADS", warrantyMonths: 12, productModelName: "2.0mm Sheet" },
};
      ...
      if (serialRecord) {
        return NextResponse.json({
          ...
          data: {
            ...
            warrantyMonths: serialRecord.product.warrantyMonths || 12,
